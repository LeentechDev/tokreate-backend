...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #eaeaea; padding: 40px 0px;"
    leftmargin="0">
    <!--100% body table-->
    <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#eaeaea"
        ...
        <tr>
            <a href="https://tokreate.com" title="logo" target="_blank">
                <img style="margin: 0 auto; display: block;" width="120" src="<?= url('logo.png') ?>" title="logo"
                    alt="logo">
            </a>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong>www.tokreate.com</strong></p>
                        </td>
                    </tr>
                    <tr>
