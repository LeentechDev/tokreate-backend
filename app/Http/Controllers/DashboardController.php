...
class DashboardController extends Controller
{
    ...
    public function getTotalEarnings(Request $request)
    {
        ...
        $res = DB::table('transactions')->select(
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 1 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as jan "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 2 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as feb "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 3 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as mar "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 4 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as apr "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 5 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as may "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 6 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as jun "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 7 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as jul "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 8 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as aug "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 9 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as sept "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 10 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as oct "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 11 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as nov "),
            DB::raw("(Select SUM(transaction_computed_commission) from transactions where EXTRACT(MONTH FROM transaction_created_at) = 12 and EXTRACT(YEAR FROM transaction_created_at) = " . $year . " and transaction_payment_status = " . Constants::TRANSACTION_PAYMENT_SUCCESS . ") as dece ")
        )->first();
